  ...
  return  (
        <div className='bg-gray-900 text-white'>
            ...
            <p className='mx-10 text-5xl'>
                ...
                <br />
                <p>with <span className='text-red-600 font-bold'>MEFIC</span></p>
            </p>
            <br />
            ...
            <button className="mx-8 translate-x-0.5 ml-right bg-red-600 flex right-3 text-white px-4 py-2 rounded">
                book a consultant
            </button>
