...
function text() {
  ...
  <img className='mx-auto mt-6 sm:mt-8 md:mt-11 w-10/12 sm:w-8/12 md:w-6/12 lg:w-5/12' src="line.png" alt="line" />

  {/* Responsive paragraph */}
  <p className='mt-4 sm:mt-6 md:mt-8 text-xs sm:text-sm text-center leading-5 sm:leading-6 md:leading-7'>
